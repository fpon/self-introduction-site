...
const milestones = [
  ...
  },
  {
    ...
    description:
      "受託開発・自社SaaSの開発に従事。物流基幹システムでは要件定義・設計・PM・上流の納期調整・開発まで一貫して担当。独自AIチャットボット開発ではPMとして累計6名（同時最大5名）をマネジメント。その他、大学教授向けシラバスチェックアプリ、お見合いアプリ（Stripe決済・WebSocketリアルタイム通信）など多数のプロジェクトを経験。組織マネジメントではリーダーとして1on1ミーティングを実施、メンターとして4名のメンティーを担当、プログラマー6名の教育も行った。",
  },
  {
    date: "2025.12",
